# 基站操作维护（OAM）系统总体设计实现报告

## Change Log
|  Date (YYYY-MM-DD) |  Version | Changed By  |  Change Description |
|---|---|---|---|
| 2024-07-01  | 1.0  | Guoliang  |  将doc文档优化后转移至GitBook |
...
![图1.1 OAM系统对外上下文定义](./Diagram/oam_outer_context-A1-C0-D1.1.png)
...
![图1.2 OAM系统对内上下文定义](./Diagram/oam_inner_context-A1-C0-D1.2.png)
...
![图1.3 OAM内部模块基类，线程池和消息分发](./Diagram/oam_base_module-A1-C0-D1.3.png)
...
![图1.4 使用CONFD进行进程间消息通信](./Diagram/oam_use_confd_sendmsg-A1-C0-D1.4.png)
...
#### 1.2.3 CONFD数据库简要说明
ConfD 是由思科（Cisco）开发的一款强大的网络配置和管理工具，广泛应用于电信和网络设备行业。它提供了基于 NETCONF 和 YANG 模型的高级配置管理能力。其内置的数据库系统，负责存储和管理设备的配置信息和运行状态
